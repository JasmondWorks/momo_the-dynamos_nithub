...
function ChatWelcome({ name = "Bolu" }) {
  ...
  return (
    <>
      <div className="p-6 lg:p-12 h-[100vh] max-w-5xl mx-auto text-sm bg-[#fdfcfc]">
        <div className="p-5 border border-neutral-400 rounded-lg h-full grid grid-rows-[auto_1fr] gap-5">

...
function Welcome(){
    ...
    return(
        <div className="relative w-full h-screen flex flex-col ">
            ...
            <div className="flex justify-between gap-4 z-125">
            ...
            <div className=" mt-6 flex flex-col md:flex-row items-start gap-2 pt-8  shadow-md"> 
                 <img src={runImg} alt="fit runner" className="w-full md:w-1/3 h-auto rounded-md float-none md:float-left" />
                 <div className="text-wrap">🎮 Welcome to MOMO Rewards! 💊✨
                    Take charge of your health and earn coins along the way! 
                ✅ Complete daily health tasks like taking medications, logging symptoms, 
                or checking your vitals 💰 Redeem your coins for exclusive perks — 
                or top up anytime with quick coin purchases Stay healthy, stay rewarded! 🚀
                
                 <button type ="submit" className=" h-12 w-36 bg-[#8E44AD] rounded-md">
